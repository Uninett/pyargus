...
- Explicit support for Python 3.8 was dropped.

### Added

- Added asyncio-compatible version of the client interface (`pyargus.async_client.AsyncClient`). Usage examples in [README.md](./README.md) were added.
- Python 3.12 and 3.13 added to test matrix for compatibility testing.
